...
ok $factory = Grinder->new(
   ...
   -length_bias     => 0                             ,
   -shared_perc     => 100                           ,
   -permuted_perc   => 0                              ), 'No species permuted';
...
ok $factory = Grinder->new(
   ...
   -length_bias     => 0                             ,
   -shared_perc     => 100                           ,
   -permuted_perc   => 40                             ), '40% species permuted';
...
ok $factory = Grinder->new(
   ...
   -length_bias     => 0                             ,
   -shared_perc     => 100                           ,
   -permuted_perc   => 60                             ), '60% species permuted';
...
ok $factory = Grinder->new(
   ...
   -length_bias     => 0                             ,
   -shared_perc     => 100                           ,
   -permuted_perc   => 80                             ), '80% species permuted';
...
ok $factory = Grinder->new(
   ...
   -length_bias     => 0                             ,
   -shared_perc     => 100                           ,
   -permuted_perc   => 100                            ), 'All species permuted';
...
ok $factory = Grinder->new(
   ...
   -diversity       => (3,5)                         ,
   -shared_perc     => 100                           ,
   -permuted_perc   => 100                            ), 'Inequal richness';
